...
| C | 403 "Nur für den Master-Tutor" auf `/api/teacher/group-uploads` (seit 2026-07-10) | Tutor-Session ohne Master-Flag — der Upload-Reiter/-Pfad ist dem Login mit dem Master-Code (`TEACHER_ARCHIVE_CODE`) vorbehalten | Mit dem Master-Code neu einloggen; Nav zeigt dann den Upload-Reiter | GEWOLLT, kein Bug |
