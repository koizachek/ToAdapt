...
| C | 423 "Feedback erst nach dem Termin" auf `/briefings/.../feedback` | Freigabedatum = Tag nach dem Touchpoint-Termin (`BRIEFING_SCHEDULE`) noch nicht erreicht | Warten; Master kann zur QS mit `force=1` (wird geloggt) | GEWOLLT (Leitplanke `feedback_only_after_session`) |
